...
//@interface LadyBugObject : NSObject
//@end

@interface LadyBugObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LadyBugObject class]])
		{
			for (NSString *key in [[(LadyBugObject*)o modules] allKeys])
			{
