...
// in simulator we redefine to format for LadyBug Developer console
...
{\
	NSString * exceptionName = [@"org.ladybug." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ladybug";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILadyBugNativeItemNone = -1, 
	UILadyBugNativeItemSpinner = -2,
	UILadyBugNativeItemProgressBar = -3,
	
	UILadyBugNativeItemSlider = -4,
	UILadyBugNativeItemSwitch = -5,
	UILadyBugNativeItemMultiButton = -6,
	UILadyBugNativeItemSegmented = -7,
	
	UILadyBugNativeItemTextView = -8,
	UILadyBugNativeItemTextField = -9,
	UILadyBugNativeItemSearchBar = -10,
	
	UILadyBugNativeItemPicker = -11,
	UILadyBugNativeItemDatePicker = -12,
	
	UILadyBugNativeItemInfoLight = -13,
	UILadyBugNativeItemInfoDark = -14,
	
	UILadyBugNativeItemDisclosure = -15,
	
	UILadyBugNativeItemContactAdd = -16
};
